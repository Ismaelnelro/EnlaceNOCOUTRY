...
export const ConditionPage = () => {
    return (
        <Layout>
            <div className="mx-5  md:mx-20 lg:mx-48 my-10">
                <h1 className="text-hoverPrimary  text-4xl font-semibold mb-5">
                    Bases y condiciones
                </h1>
                {terms.map((intro) => (
                    <div key={intro.title} className='text-secondary'>
                        <h2 className="font-semibold">{intro.title}</h2>
                        <p className="text-sm p-4">{intro.paragraph}</p>
                    </div>
                ))}
                <div className="p-4  my-10  border border-1 border-hoverPrimary rounded-2xl ">
                    <details className="group">
                        <summary className="flex justify-between items-center font-medium cursor-pointer list-none">
                            <h2 className="text-xl font-semibold text-hoverPrimary">
                        ...
                        <ul className="text-sm list-disc ml-7">
                            {volunteer.map((vol) => (
                                <li key={vol.list} className="my-7">
                                    {vol.list}
                                </li>
                            ))}
                        </ul>
                ...
                <div className="flex justify-center rounded-lg bg-primary p-2">
                    <p className="text-base font-bold  text-center  text-white ">
                        ...
                        cumplir <span className='text-secondary'> todas</span> las bases y condiciones aquí establecidas.
                    </p>
                </div>
            </div>
        </Layout>
