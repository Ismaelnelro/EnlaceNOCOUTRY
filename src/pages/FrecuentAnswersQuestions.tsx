...
const FrecuentAnswersQuestions = () => {
    return (
        <Layout>
            <h1 className="mx-20 mt-10 mb-4 text-4xl font-semibold  text-hoverPrimary">
                Preguntas frecuentes
            </h1>

            <h2 className="flex justify-center py-6 px-3 text-4xl font-medium leading-6 text-white bg-primary  ">
                Voluntarios
            </h2>


            {questionVol.map((quest) => (
                <div className="min-h-[80px] px-4 py-2 my-10 mx-10 lg:mx-52 grid items-center border border-1 border-hoverPrimary rounded-2xl ">
                    <details key={quest.question}
                        className="group">
                        <summary className="flex justify-between items-center font-medium cursor-pointer list-none">
                            <h3 className=" md:text-xl text-md font-semibold text-hoverPrimary">
                                {quest.question}
                            </h3>
                            <span className="text-hoverPrimary transition group-open:rotate-180">
                                <ExpandMoreIcon />
                            </span>
                        </summary>
                        <p className="my-3 text-md  text-secondary">{quest.answer}</p>
                    </details>
                </div>
            ))}
...
export default FrecuentAnswersQuestions;